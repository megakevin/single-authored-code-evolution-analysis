#Usage: $ python3 get_bug_commit_ratio_per_file.py /home/kevin/Desktop/repos/facebook-android-sdk bug_commit_ratio.csv
# python3 get_bug_commit_ratio_per_file.py <git_repo_path> <output_file>
...
def get_bug_commit_ratio_per_file(git_repo, output_file):
    result = []
    exec_dir = os.getcwd()
...
def main():
    ...
    get_bug_commit_ratio_per_file(repo_path, output_file)
